...
__device__ __forceinline__ void keccak_f1600_init(uint2* state)
{
	...
	s[6] = ROL2_32(s[9], 20);
	s[9] = ROL2_64(s[22], 61);
	s[22] = ROL2_64(s[14], 39);
	s[14] = ROL2_32(s[20], 18);
	s[20] = ROL2_64(s[2], 62);
	s[2] = ROL2_64(s[12], 43);
	s[12] = ROL2_32(s[13], 25);
	s[13] = ROL2_32(s[19], 8);
	s[19] = ROL2_64(s[23], 56);
	s[23] = ROL2_64(s[15], 41);
	s[15] = ROL2_32(s[4], 27);
	s[4] = ROL2_32(s[24], 14);
	s[24] = ROL2_32(s[21], 2);
	s[21] = ROL2_64(s[8], 55);
	...
	s[5] = ROL2_32(s[3], 28);
	s[3] = ROL2_32(s[18], 21);
	s[18] = ROL2_32(s[17], 15);
	s[17] = ROL2_32(s[11], 10);
	s[11] = ROL2_32(s[7], 6);
	s[7] = ROL2_32(s[10], 3);
	s[10] = ROL2_32(u, 1);
...
__device__ __forceinline__ uint64_t keccak_f1600_final(uint2* state)
{
	...
	s[0] = xor3(s[0], t[4], ROL2_32(t[1], 1));
	s[6] = xor3(s[6], t[0], ROL2_32(t[2], 1));
	s[12] = xor3(s[12], t[1], ROL2_32(t[3], 1));
